      ...
      <footer className="footer">
            <div className="footer-container">
                <div className="footer-section">
                    <img src="./public/assets/VA-Logo2.png" alt="" width={200} className='mb-3 pt-0' />
                ...
                <div className="footer-section">
                    <h4> Contact Us</h4>
                    <p className='p2'><CiLocationOn />  Mathura Road , Faridabad Sec-28 , Haryana</p>
                    <p className='p2'><MdAttachEmail />  info@velocityautomation.co.in</p>
                    <p className='p2'><CgWebsite />  www.velocityautomation.co.in</p>
                    <p className='p2'><MdContactEmergency />  + 98182 93887</p>
                </div>
            </div>
